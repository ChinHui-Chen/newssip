...
-- 資料庫: `RiverCrab`
--
CREATE DATABASE `RiverCrab` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `RiverCrab`;
...
INSERT INTO `category` VALUES(5, 'entertainment', 0);
INSERT INTO `category` VALUES(6, 'technology', 1);
INSERT INTO `category` VALUES(7, 'politics', 1);
INSERT INTO `category` VALUES(8, 'society', 0);
...
-- 資料庫: `airs2010`
--
CREATE DATABASE `airs2010` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `airs2010`;
...
CREATE TABLE `registration` (
  ...
  `birth_date` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `affiliation` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `paper_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `is_speaker` smallint(6) NOT NULL,
...
--
-- 列出以下資料庫的數據： `registration`
--

INSERT INTO `registration` VALUES(1, 'id4c918c24513c7', 'Prof.', 'a', 'b', 'b94058@csie.ntu.edu.tw', 'Male', '11/08/2018', 'TW', 'adferasdf,ad,f,wer,eer,q', '123232', '231802830', 'ntu', '213,12,33,', 1, 0, '2010-09-16 11:16:52');
INSERT INTO `registration` VALUES(2, 'id4c91933fb61d1', 'Dr.', 'b', 'c', 'todo2015@gmail.com', 'Female', '213', 'AF', 'a', 'a', 'b', 'c', 'e', 0, 0, '2010-09-16 11:47:11');
--
...
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'category', 'id', 1, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(3)', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'category', 'name', 2, NULL, 'NO', 'varchar', 32, 96, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(32)', 'MUL', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'category', 'parent_id', 3, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(3)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'comment', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'comment', 'post_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'MUL', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'comment', 'user_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'comment', 'content', 4, NULL, 'NO', 'varchar', 128, 384, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(128)', 'MUL', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'comment', 'timestamp', 5, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', 'on update CURRENT_TIMESTAMP', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'post', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'post', 'user_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'post', 'title', 3, NULL, 'NO', 'varchar', 128, 384, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(128)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'post', 'content', 4, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'text', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'post', 'post_type', 5, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', 'MUL', '', 'select,insert,update,references', '1 for news, 2 for post, 3 for reply');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'post', 'parent_id', 6, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'post', 'src_link', 7, NULL, 'YES', 'varchar', 255, 765, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(255)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'post', 'category_id', 8, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(3)', 'MUL', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'post', 'timestamp', 9, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'post_reply', 'parent_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'post_reply', 'reply_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'user', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(10) unsigned', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'user', 'name', 2, NULL, 'NO', 'varchar', 16, 48, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(16)', 'MUL', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'user', 'email', 3, NULL, 'NO', 'varchar', 64, 192, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(64)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'user', 'fb_uid', 4, NULL, 'NO', 'varchar', 16, 48, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(16)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'user', 'reg_time', 5, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', 'on update CURRENT_TIMESTAMP', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'RiverCrab', 'user', 'last_login_time', 6, '0000-00-00 00:00:00', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'reg_id', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'title', 3, NULL, 'NO', 'varchar', 5, 15, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(5)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'first_name', 4, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(50)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'last_name', 5, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(50)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'email', 6, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(50)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'sex', 7, NULL, 'NO', 'varchar', 7, 21, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(7)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'birth_date', 8, NULL, 'NO', 'varchar', 11, 33, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'country', 9, NULL, 'NO', 'varchar', 3, 9, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(3)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'address', 10, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'zip_code', 11, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(10)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'telephone', 12, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(20)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'affiliation', 13, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(50)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'paper_id', 14, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_unicode_ci', 'varchar(100)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'is_speaker', 15, NULL, 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'is_pay', 16, '0', 'NO', 'smallint', NULL, NULL, 5, 0, NULL, NULL, 'smallint(6)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'airs2010', 'registration', 'reg_time', 17, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', '');
...
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'post', 'post_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'post', 'tag_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'post', 'parent_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'post', 'owner_id', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'post', 'title', 5, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', 'MUL', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'post', 'content', 6, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', 'MUL', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'post', 'timestamp', 7, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'push', 'push_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'push', 'user_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'push', 'content', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'push', 'timestamp', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'tag', 'tag_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'tag', 'tag', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'tag', 'parent_id', 3, '0', 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'user', 'user_id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'user', 'username', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'user', 'password', 3, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'user_fav', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'user_fav', 'user_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'user_fav', 'fav_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'user_fav', 'tag_ids', 4, NULL, 'NO', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'user_post', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'user_post', 'user_id', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'user_post', 'post_id', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` VALUES(NULL, 'peace', 'user_post', 'timestamp', 4, 'CURRENT_TIMESTAMP', 'NO', 'timestamp', NULL, NULL, NULL, NULL, NULL, NULL, 'timestamp', '', 'on update CURRENT_TIMESTAMP', 'select,insert,update,references', '');
...
INSERT INTO `GLOBAL_STATUS` VALUES('BYTES_RECEIVED', '582441');
INSERT INTO `GLOBAL_STATUS` VALUES('BYTES_SENT', '4434487');
...
INSERT INTO `GLOBAL_STATUS` VALUES('COM_CHANGE_DB', '10');
INSERT INTO `GLOBAL_STATUS` VALUES('COM_CHANGE_MASTER', '0');
INSERT INTO `GLOBAL_STATUS` VALUES('COM_CHECK', '23');
...
INSERT INTO `GLOBAL_STATUS` VALUES('COM_INSERT', '11');
...
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SELECT', '2189');
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SET_OPTION', '537');
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SHOW_AUTHORS', '0');
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SHOW_BINLOG_EVENTS', '0');
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SHOW_BINLOGS', '4');
...
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SHOW_CREATE_TABLE', '1879');
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SHOW_CREATE_TRIGGER', '0');
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SHOW_DATABASES', '9');
...
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SHOW_PLUGINS', '16');
...
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SHOW_TABLE_STATUS', '230');
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SHOW_TABLES', '43');
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SHOW_TRIGGERS', '79');
INSERT INTO `GLOBAL_STATUS` VALUES('COM_SHOW_VARIABLES', '1');
...
INSERT INTO `GLOBAL_STATUS` VALUES('COM_UPDATE', '5');
...
INSERT INTO `GLOBAL_STATUS` VALUES('CONNECTIONS', '429');
INSERT INTO `GLOBAL_STATUS` VALUES('CREATED_TMP_DISK_TABLES', '2040');
INSERT INTO `GLOBAL_STATUS` VALUES('CREATED_TMP_FILES', '5');
INSERT INTO `GLOBAL_STATUS` VALUES('CREATED_TMP_TABLES', '3035');
...
INSERT INTO `GLOBAL_STATUS` VALUES('HANDLER_READ_FIRST', '398');
INSERT INTO `GLOBAL_STATUS` VALUES('HANDLER_READ_KEY', '1828');
INSERT INTO `GLOBAL_STATUS` VALUES('HANDLER_READ_NEXT', '14438');
INSERT INTO `GLOBAL_STATUS` VALUES('HANDLER_READ_PREV', '0');
INSERT INTO `GLOBAL_STATUS` VALUES('HANDLER_READ_RND', '1815');
INSERT INTO `GLOBAL_STATUS` VALUES('HANDLER_READ_RND_NEXT', '21308');
...
INSERT INTO `GLOBAL_STATUS` VALUES('HANDLER_UPDATE', '5');
INSERT INTO `GLOBAL_STATUS` VALUES('HANDLER_WRITE', '13514');
...
INSERT INTO `GLOBAL_STATUS` VALUES('KEY_BLOCKS_UNUSED', '7225');
INSERT INTO `GLOBAL_STATUS` VALUES('KEY_BLOCKS_USED', '20');
INSERT INTO `GLOBAL_STATUS` VALUES('KEY_READ_REQUESTS', '26014');
INSERT INTO `GLOBAL_STATUS` VALUES('KEY_READS', '20');
INSERT INTO `GLOBAL_STATUS` VALUES('KEY_WRITE_REQUESTS', '31');
INSERT INTO `GLOBAL_STATUS` VALUES('KEY_WRITES', '31');
...
INSERT INTO `GLOBAL_STATUS` VALUES('OPEN_FILES', '70');
INSERT INTO `GLOBAL_STATUS` VALUES('OPEN_STREAMS', '0');
INSERT INTO `GLOBAL_STATUS` VALUES('OPEN_TABLE_DEFINITIONS', '35');
INSERT INTO `GLOBAL_STATUS` VALUES('OPEN_TABLES', '35');
INSERT INTO `GLOBAL_STATUS` VALUES('OPENED_FILES', '8537');
INSERT INTO `GLOBAL_STATUS` VALUES('OPENED_TABLE_DEFINITIONS', '35');
INSERT INTO `GLOBAL_STATUS` VALUES('OPENED_TABLES', '112');
...
INSERT INTO `GLOBAL_STATUS` VALUES('QUERIES', '7271');
INSERT INTO `GLOBAL_STATUS` VALUES('QUESTIONS', '7271');
...
INSERT INTO `GLOBAL_STATUS` VALUES('SELECT_RANGE', '24');
INSERT INTO `GLOBAL_STATUS` VALUES('SELECT_RANGE_CHECK', '0');
INSERT INTO `GLOBAL_STATUS` VALUES('SELECT_SCAN', '3042');
...
INSERT INTO `GLOBAL_STATUS` VALUES('SORT_RANGE', '367');
INSERT INTO `GLOBAL_STATUS` VALUES('SORT_ROWS', '5837');
INSERT INTO `GLOBAL_STATUS` VALUES('SORT_SCAN', '4');
INSERT INTO `GLOBAL_STATUS` VALUES('TABLE_LOCKS_IMMEDIATE', '2873');
...
INSERT INTO `GLOBAL_STATUS` VALUES('THREADS_CREATED', '428');
INSERT INTO `GLOBAL_STATUS` VALUES('THREADS_RUNNING', '1');
INSERT INTO `GLOBAL_STATUS` VALUES('UPTIME', '21365');
INSERT INTO `GLOBAL_STATUS` VALUES('UPTIME_SINCE_FLUSH_STATUS', '21365');
...
INSERT INTO `GLOBAL_VARIABLES` VALUES('TMPDIR', '/var/folders/60/60Oq0lJkF6Kx32vWwN5iUU+++TI/-Tmp-/');
...
INSERT INTO `GLOBAL_VARIABLES` VALUES('HOSTNAME', 'MBP.local');
...
INSERT INTO `GLOBAL_VARIABLES` VALUES('TIMESTAMP', '1298209242');
...
INSERT INTO `GLOBAL_VARIABLES` VALUES('SYSTEM_TIME_ZONE', 'CST');
...
INSERT INTO `GLOBAL_VARIABLES` VALUES('SLAVE_LOAD_TMPDIR', '/var/folders/60/60Oq0lJkF6Kx32vWwN5iUU+++TI/-Tmp-/');
...
INSERT INTO `KEY_COLUMN_USAGE` VALUES(NULL, 'RiverCrab', 'PRIMARY', NULL, 'RiverCrab', 'category', 'id', 1, NULL, NULL, NULL, NULL);
INSERT INTO `KEY_COLUMN_USAGE` VALUES(NULL, 'RiverCrab', 'PRIMARY', NULL, 'RiverCrab', 'comment', 'id', 1, NULL, NULL, NULL, NULL);
INSERT INTO `KEY_COLUMN_USAGE` VALUES(NULL, 'RiverCrab', 'PRIMARY', NULL, 'RiverCrab', 'post', 'id', 1, NULL, NULL, NULL, NULL);
INSERT INTO `KEY_COLUMN_USAGE` VALUES(NULL, 'RiverCrab', 'PRIMARY', NULL, 'RiverCrab', 'post_reply', 'reply_id', 1, NULL, NULL, NULL, NULL);
INSERT INTO `KEY_COLUMN_USAGE` VALUES(NULL, 'RiverCrab', 'PRIMARY', NULL, 'RiverCrab', 'user', 'id', 1, NULL, NULL, NULL, NULL);
INSERT INTO `KEY_COLUMN_USAGE` VALUES(NULL, 'airs2010', 'PRIMARY', NULL, 'airs2010', 'registration', 'id', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `KEY_COLUMN_USAGE` VALUES(NULL, 'peace', 'PRIMARY', NULL, 'peace', 'post', 'post_id', 1, NULL, NULL, NULL, NULL);
INSERT INTO `KEY_COLUMN_USAGE` VALUES(NULL, 'peace', 'PRIMARY', NULL, 'peace', 'tag', 'tag_id', 1, NULL, NULL, NULL, NULL);
INSERT INTO `KEY_COLUMN_USAGE` VALUES(NULL, 'peace', 'PRIMARY', NULL, 'peace', 'user', 'user_id', 1, NULL, NULL, NULL, NULL);
INSERT INTO `KEY_COLUMN_USAGE` VALUES(NULL, 'peace', 'PRIMARY', NULL, 'peace', 'user_fav', 'id', 1, NULL, NULL, NULL, NULL);
INSERT INTO `KEY_COLUMN_USAGE` VALUES(NULL, 'peace', 'PRIMARY', NULL, 'peace', 'user_post', 'id', 1, NULL, NULL, NULL, NULL);
...
INSERT INTO `PARTITIONS` VALUES(NULL, 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, NULL, '', '', NULL);
...
INSERT INTO `PARTITIONS` VALUES(NULL, 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, NULL, '', '', NULL);
...
INSERT INTO `PARTITIONS` VALUES(NULL, 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, NULL, '', '', NULL);
...
INSERT INTO `PARTITIONS` VALUES(NULL, 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, NULL, '', '', NULL);
...
INSERT INTO `PARTITIONS` VALUES(NULL, 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, NULL, '', '', NULL);
...
INSERT INTO `PARTITIONS` VALUES(NULL, 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'RiverCrab', 'category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 20, 200, 281474976710655, 3072, 0, '2011-02-20 08:42:57', '2011-02-20 08:43:24', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'RiverCrab', 'comment', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 10, 26, 260, 281474976710655, 4096, 0, '2011-02-14 21:29:37', '2011-02-20 21:06:43', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'RiverCrab', 'post', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 43, 559, 24052, 281474976710655, 4096, 0, '2011-02-19 09:18:02', '2011-02-20 21:06:13', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'RiverCrab', 'post_reply', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 9, 27, 2533274790395903, 3072, 0, '2011-02-14 21:29:37', '2011-02-14 21:29:37', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'RiverCrab', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 44, 132, 281474976710655, 3072, 0, '2011-02-14 21:29:37', '2011-02-20 21:08:44', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'airs2010', 'registration', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 110, 220, 281474976710655, 2048, 0, '2010-09-16 11:13:46', '2010-09-16 11:47:22', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2009-08-11 20:59:57', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 440, 2200, 123848989752688639, 5120, 0, '2009-08-11 21:00:04', '2011-01-24 08:45:34', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2009-08-11 21:00:03', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2009-08-11 20:59:58', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 36, 581, 20916, 163536961468891135, 3072, 0, '2006-03-15 22:53:39', '2010-03-06 16:37:31', '2009-08-11 20:59:56', NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 378, 197, 74466, 55450570411999231, 13312, 0, '2006-03-15 22:53:40', '2010-03-06 16:37:31', '2009-08-11 20:59:56', NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 726, 9, 6534, 2533274790395903, 12288, 0, '2006-03-15 22:53:39', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 458, 537, 246268, 281474976710655, 15360, 0, '2006-03-15 22:53:39', '2010-03-06 16:37:31', '2009-08-11 20:59:56', NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2009-08-11 21:00:03', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2009-08-11 20:59:57', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162411061562048511, 1024, 0, '2009-08-11 20:59:56', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2009-08-11 21:00:02', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2009-08-11 21:00:01', '2010-03-06 16:37:31', '2009-08-11 21:00:01', NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2009-08-11 20:59:56', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2009-08-11 21:00:04', '2010-03-06 16:37:31', '2009-08-11 21:00:04', NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2006-03-15 22:53:40', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2006-03-15 22:53:40', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2006-03-15 22:53:40', '2010-03-06 16:37:31', '2009-08-11 20:59:56', NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2006-03-15 22:53:40', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2006-03-15 22:53:40', '2010-03-06 16:37:31', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 84, 424, 281474976710655, 2048, 0, '2009-08-11 21:00:03', '2011-01-24 08:45:34', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'peace', 'post', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 13, 1269, 16500, 281474976710655, 17408, 0, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'peace', 'push', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'peace', 'tag', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11, 21, 236, 281474976710655, 2048, 0, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'peace', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 25, 176, 281474976710655, 3072, 0, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'peace', 'user_fav', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 20, 100, 281474976710655, 2048, 0, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, NULL, '', '', NULL);
INSERT INTO `PARTITIONS` VALUES(NULL, 'peace', 'user_post', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 17, 68, 4785074604081151, 2048, 0, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, NULL, '', '', NULL);
...
INSERT INTO `PROCESSLIST` VALUES(428, 'root', 'localhost', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
INSERT INTO `SCHEMATA` VALUES(NULL, 'RiverCrab', 'latin1', 'latin1_swedish_ci', NULL);
INSERT INTO `SCHEMATA` VALUES(NULL, 'airs2010', 'latin1', 'latin1_swedish_ci', NULL);
INSERT INTO `SCHEMATA` VALUES(NULL, 'mysql', 'latin1', 'latin1_swedish_ci', NULL);
INSERT INTO `SCHEMATA` VALUES(NULL, 'peace', 'latin1', 'latin1_swedish_ci', NULL);
...
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'SELECT', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'INSERT', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'UPDATE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'DELETE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'CREATE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'DROP', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'REFERENCES', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'INDEX', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'ALTER', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'CREATE TEMPORARY TABLES', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'LOCK TABLES', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'EXECUTE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'CREATE VIEW', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'SHOW VIEW', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'CREATE ROUTINE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'ALTER ROUTINE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'EVENT', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'airs2010', 'TRIGGER', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'SELECT', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'INSERT', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'UPDATE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'DELETE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'CREATE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'DROP', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'REFERENCES', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'INDEX', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'ALTER', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'CREATE TEMPORARY TABLES', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'LOCK TABLES', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'EXECUTE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'CREATE VIEW', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'SHOW VIEW', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'CREATE ROUTINE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'ALTER ROUTINE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'EVENT', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'peace', 'TRIGGER', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'SELECT', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'INSERT', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'UPDATE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'DELETE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'CREATE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'DROP', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'REFERENCES', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'INDEX', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'ALTER', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'CREATE TEMPORARY TABLES', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'LOCK TABLES', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'EXECUTE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'CREATE VIEW', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'SHOW VIEW', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'CREATE ROUTINE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'ALTER ROUTINE', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'EVENT', 'NO');
INSERT INTO `SCHEMA_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'RiverCrab', 'TRIGGER', 'NO');
...
INSERT INTO `SESSION_STATUS` VALUES('BYTES_RECEIVED', '10692');
INSERT INTO `SESSION_STATUS` VALUES('BYTES_SENT', '269057');
...
INSERT INTO `SESSION_STATUS` VALUES('COM_SELECT', '28');
INSERT INTO `SESSION_STATUS` VALUES('COM_SET_OPTION', '30');
...
INSERT INTO `SESSION_STATUS` VALUES('COM_SHOW_CREATE_TABLE', '26');
...
INSERT INTO `SESSION_STATUS` VALUES('COM_SHOW_TABLES', '3');
INSERT INTO `SESSION_STATUS` VALUES('COM_SHOW_TRIGGERS', '25');
...
INSERT INTO `SESSION_STATUS` VALUES('CONNECTIONS', '429');
INSERT INTO `SESSION_STATUS` VALUES('CREATED_TMP_DISK_TABLES', '94');
INSERT INTO `SESSION_STATUS` VALUES('CREATED_TMP_FILES', '5');
INSERT INTO `SESSION_STATUS` VALUES('CREATED_TMP_TABLES', '337');
...
INSERT INTO `SESSION_STATUS` VALUES('HANDLER_READ_RND_NEXT', '2000');
...
INSERT INTO `SESSION_STATUS` VALUES('HANDLER_WRITE', '1969');
...
INSERT INTO `SESSION_STATUS` VALUES('KEY_BLOCKS_UNUSED', '7225');
INSERT INTO `SESSION_STATUS` VALUES('KEY_BLOCKS_USED', '20');
INSERT INTO `SESSION_STATUS` VALUES('KEY_READ_REQUESTS', '26014');
INSERT INTO `SESSION_STATUS` VALUES('KEY_READS', '20');
INSERT INTO `SESSION_STATUS` VALUES('KEY_WRITE_REQUESTS', '31');
INSERT INTO `SESSION_STATUS` VALUES('KEY_WRITES', '31');
...
INSERT INTO `SESSION_STATUS` VALUES('OPEN_FILES', '70');
INSERT INTO `SESSION_STATUS` VALUES('OPEN_STREAMS', '0');
INSERT INTO `SESSION_STATUS` VALUES('OPEN_TABLE_DEFINITIONS', '35');
INSERT INTO `SESSION_STATUS` VALUES('OPEN_TABLES', '35');
INSERT INTO `SESSION_STATUS` VALUES('OPENED_FILES', '8773');
INSERT INTO `SESSION_STATUS` VALUES('OPENED_TABLE_DEFINITIONS', '0');
INSERT INTO `SESSION_STATUS` VALUES('OPENED_TABLES', '35');
...
INSERT INTO `SESSION_STATUS` VALUES('QUERIES', '7348');
INSERT INTO `SESSION_STATUS` VALUES('QUESTIONS', '189');
...
INSERT INTO `SESSION_STATUS` VALUES('SELECT_SCAN', '133');
...
INSERT INTO `SESSION_STATUS` VALUES('TABLE_LOCKS_IMMEDIATE', '2874');
...
INSERT INTO `SESSION_STATUS` VALUES('THREADS_CREATED', '428');
INSERT INTO `SESSION_STATUS` VALUES('THREADS_RUNNING', '1');
INSERT INTO `SESSION_STATUS` VALUES('UPTIME', '21365');
INSERT INTO `SESSION_STATUS` VALUES('UPTIME_SINCE_FLUSH_STATUS', '21365');
...
INSERT INTO `SESSION_VARIABLES` VALUES('PSEUDO_THREAD_ID', '428');
...
INSERT INTO `SESSION_VARIABLES` VALUES('TMPDIR', '/var/folders/60/60Oq0lJkF6Kx32vWwN5iUU+++TI/-Tmp-/');
...
INSERT INTO `SESSION_VARIABLES` VALUES('HOSTNAME', 'MBP.local');
...
INSERT INTO `SESSION_VARIABLES` VALUES('TIMESTAMP', '1298209242');
...
INSERT INTO `SESSION_VARIABLES` VALUES('SYSTEM_TIME_ZONE', 'CST');
...
INSERT INTO `SESSION_VARIABLES` VALUES('SLAVE_LOAD_TMPDIR', '/var/folders/60/60Oq0lJkF6Kx32vWwN5iUU+++TI/-Tmp-/');
...
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'category', 0, 'RiverCrab', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'category', 1, 'RiverCrab', 'name', 1, 'name', 'A', NULL, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'comment', 0, 'RiverCrab', 'PRIMARY', 1, 'id', 'A', 10, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'comment', 1, 'RiverCrab', 'post_id', 1, 'post_id', 'A', NULL, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'comment', 1, 'RiverCrab', 'post_id', 2, 'user_id', 'A', NULL, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'comment', 1, 'RiverCrab', 'content', 1, 'content', NULL, NULL, NULL, NULL, '', 'FULLTEXT', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'post', 0, 'RiverCrab', 'PRIMARY', 1, 'id', 'A', 43, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'post', 1, 'RiverCrab', 'category_id', 1, 'category_id', 'A', NULL, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'post', 1, 'RiverCrab', 'post_type', 1, 'post_type', 'A', NULL, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'post_reply', 0, 'RiverCrab', 'PRIMARY', 1, 'reply_id', 'A', 3, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'post_reply', 1, 'RiverCrab', 'parent_id', 1, 'parent_id', 'A', NULL, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'user', 0, 'RiverCrab', 'PRIMARY', 1, 'id', 'A', 3, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'RiverCrab', 'user', 1, 'RiverCrab', 'name', 1, 'name', 'A', NULL, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'airs2010', 'registration', 0, 'airs2010', 'PRIMARY', 1, 'id', 'A', 2, NULL, NULL, '', 'BTREE', '');
...
INSERT INTO `STATISTICS` VALUES(NULL, 'mysql', 'db', 0, 'mysql', 'PRIMARY', 3, 'User', 'A', 5, NULL, NULL, '', 'BTREE', '');
...
INSERT INTO `STATISTICS` VALUES(NULL, 'mysql', 'user', 0, 'mysql', 'PRIMARY', 2, 'User', 'A', 5, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'peace', 'post', 0, 'peace', 'PRIMARY', 1, 'post_id', 'A', 13, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'peace', 'post', 1, 'peace', 'title', 1, 'title', 'A', NULL, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'peace', 'post', 1, 'peace', 'content', 1, 'content', NULL, NULL, NULL, NULL, '', 'FULLTEXT', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'peace', 'tag', 0, 'peace', 'PRIMARY', 1, 'tag_id', 'A', 11, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'peace', 'user', 0, 'peace', 'PRIMARY', 1, 'user_id', 'A', 7, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'peace', 'user', 1, 'peace', 'user_id', 1, 'user_id', 'A', NULL, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'peace', 'user_fav', 0, 'peace', 'PRIMARY', 1, 'id', 'A', 5, NULL, NULL, '', 'BTREE', '');
INSERT INTO `STATISTICS` VALUES(NULL, 'peace', 'user_post', 0, 'peace', 'PRIMARY', 1, 'id', 'A', 4, NULL, NULL, '', 'BTREE', '');
...
INSERT INTO `TABLES` VALUES(NULL, 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, 'utf8_general_ci', NULL, 'max_rows=4560', '');
...
INSERT INTO `TABLES` VALUES(NULL, 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, 'utf8_general_ci', NULL, 'max_rows=618', '');
...
INSERT INTO `TABLES` VALUES(NULL, 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, 'utf8_general_ci', NULL, 'max_rows=5612', '');
INSERT INTO `TABLES` VALUES(NULL, 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, 'utf8_general_ci', NULL, 'max_rows=13025', '');
INSERT INTO `TABLES` VALUES(NULL, 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', '');
...
INSERT INTO `TABLES` VALUES(NULL, 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, 'utf8_general_ci', NULL, 'max_rows=588', '');
...
INSERT INTO `TABLES` VALUES(NULL, 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, 'utf8_general_ci', NULL, 'max_rows=569', '');
...
INSERT INTO `TABLES` VALUES(NULL, 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2011-02-20 21:40:42', '2011-02-20 21:40:42', NULL, 'utf8_general_ci', NULL, 'max_rows=6932', '');
INSERT INTO `TABLES` VALUES(NULL, 'RiverCrab', 'category', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 10, 20, 200, 281474976710655, 3072, 0, 13, '2011-02-20 08:42:57', '2011-02-20 08:43:24', NULL, 'utf8_unicode_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'RiverCrab', 'comment', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 10, 26, 260, 281474976710655, 4096, 0, 11, '2011-02-14 21:29:37', '2011-02-20 21:06:43', NULL, 'utf8_unicode_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'RiverCrab', 'post', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 43, 559, 24052, 281474976710655, 4096, 0, 62, '2011-02-19 09:18:02', '2011-02-20 21:06:13', NULL, 'utf8_unicode_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'RiverCrab', 'post_reply', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 3, 9, 27, 2533274790395903, 3072, 0, NULL, '2011-02-14 21:29:37', '2011-02-14 21:29:37', NULL, 'latin1_swedish_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'RiverCrab', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 3, 44, 132, 281474976710655, 3072, 0, 8, '2011-02-14 21:29:37', '2011-02-20 21:08:44', NULL, 'utf8_unicode_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'airs2010', 'registration', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 110, 220, 281474976710655, 2048, 0, 3, '2010-09-16 11:13:46', '2010-09-16 11:47:22', NULL, 'utf8_unicode_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2009-08-11 20:59:57', '2010-03-06 16:37:31', NULL, 'utf8_bin', NULL, '', 'Column privileges');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 5, 440, 2200, 123848989752688639, 5120, 0, NULL, '2009-08-11 21:00:04', '2011-01-24 08:45:34', NULL, 'utf8_bin', NULL, '', 'Database privileges');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2009-08-11 21:00:03', '2010-03-06 16:37:31', NULL, 'utf8_general_ci', NULL, '', 'Events');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2009-08-11 20:59:58', '2010-03-06 16:37:31', NULL, 'utf8_bin', NULL, '', 'User defined functions');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 36, 581, 20916, 163536961468891135, 3072, 0, NULL, '2006-03-15 22:53:39', '2010-03-06 16:37:31', '2009-08-11 20:59:56', 'utf8_general_ci', NULL, '', 'help categories');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 378, 197, 74466, 55450570411999231, 13312, 0, NULL, '2006-03-15 22:53:40', '2010-03-06 16:37:31', '2009-08-11 20:59:56', 'utf8_general_ci', NULL, '', 'help keywords');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 726, 9, 6534, 2533274790395903, 12288, 0, NULL, '2006-03-15 22:53:39', '2010-03-06 16:37:31', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 458, 537, 246268, 281474976710655, 15360, 0, NULL, '2006-03-15 22:53:39', '2010-03-06 16:37:31', '2009-08-11 20:59:56', 'utf8_general_ci', NULL, '', 'help topics');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2009-08-11 21:00:03', '2010-03-06 16:37:31', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2009-08-11 20:59:57', '2010-03-06 16:37:31', NULL, 'latin1_swedish_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162411061562048511, 1024, 0, NULL, '2009-08-11 20:59:56', '2010-03-06 16:37:31', NULL, 'utf8_bin', NULL, '', 'MySQL plugins');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2009-08-11 21:00:02', '2010-03-06 16:37:31', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2009-08-11 21:00:01', '2010-03-06 16:37:31', '2009-08-11 21:00:01', 'utf8_bin', NULL, '', 'Procedure privileges');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2009-08-11 20:59:56', '2010-03-06 16:37:31', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 0, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2009-08-11 21:00:04', '2010-03-06 16:37:31', '2009-08-11 21:00:04', 'utf8_bin', NULL, '', 'Table privileges');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2006-03-15 22:53:40', '2010-03-06 16:37:31', NULL, 'utf8_general_ci', NULL, '', 'Time zones');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2006-03-15 22:53:40', '2010-03-06 16:37:31', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2006-03-15 22:53:40', '2010-03-06 16:37:31', '2009-08-11 20:59:56', 'utf8_general_ci', NULL, '', 'Time zone names');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2006-03-15 22:53:40', '2010-03-06 16:37:31', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2006-03-15 22:53:40', '2010-03-06 16:37:31', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types');
INSERT INTO `TABLES` VALUES(NULL, 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 84, 424, 281474976710655, 2048, 0, NULL, '2009-08-11 21:00:03', '2011-01-24 08:45:34', NULL, 'utf8_bin', NULL, '', 'Users and global privileges');
INSERT INTO `TABLES` VALUES(NULL, 'peace', 'post', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 13, 1269, 16500, 281474976710655, 17408, 0, 15, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, 'utf8_general_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'peace', 'push', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, 'utf8_general_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'peace', 'tag', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 11, 21, 236, 281474976710655, 2048, 0, 12, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, 'utf8_general_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'peace', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 7, 25, 176, 281474976710655, 3072, 0, 8, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, 'utf8_general_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'peace', 'user_fav', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 5, 20, 100, 281474976710655, 2048, 0, 6, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, 'latin1_swedish_ci', NULL, '', '');
INSERT INTO `TABLES` VALUES(NULL, 'peace', 'user_post', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 4, 17, 68, 4785074604081151, 2048, 0, 5, '2010-11-03 18:43:49', '2010-11-03 18:43:49', NULL, 'utf8_general_ci', NULL, '', '');
...
INSERT INTO `TABLE_CONSTRAINTS` VALUES(NULL, 'RiverCrab', 'PRIMARY', 'RiverCrab', 'category', 'PRIMARY KEY');
INSERT INTO `TABLE_CONSTRAINTS` VALUES(NULL, 'RiverCrab', 'PRIMARY', 'RiverCrab', 'comment', 'PRIMARY KEY');
INSERT INTO `TABLE_CONSTRAINTS` VALUES(NULL, 'RiverCrab', 'PRIMARY', 'RiverCrab', 'post', 'PRIMARY KEY');
INSERT INTO `TABLE_CONSTRAINTS` VALUES(NULL, 'RiverCrab', 'PRIMARY', 'RiverCrab', 'post_reply', 'PRIMARY KEY');
INSERT INTO `TABLE_CONSTRAINTS` VALUES(NULL, 'RiverCrab', 'PRIMARY', 'RiverCrab', 'user', 'PRIMARY KEY');
INSERT INTO `TABLE_CONSTRAINTS` VALUES(NULL, 'airs2010', 'PRIMARY', 'airs2010', 'registration', 'PRIMARY KEY');
...
INSERT INTO `TABLE_CONSTRAINTS` VALUES(NULL, 'peace', 'PRIMARY', 'peace', 'post', 'PRIMARY KEY');
INSERT INTO `TABLE_CONSTRAINTS` VALUES(NULL, 'peace', 'PRIMARY', 'peace', 'tag', 'PRIMARY KEY');
INSERT INTO `TABLE_CONSTRAINTS` VALUES(NULL, 'peace', 'PRIMARY', 'peace', 'user', 'PRIMARY KEY');
INSERT INTO `TABLE_CONSTRAINTS` VALUES(NULL, 'peace', 'PRIMARY', 'peace', 'user_fav', 'PRIMARY KEY');
INSERT INTO `TABLE_CONSTRAINTS` VALUES(NULL, 'peace', 'PRIMARY', 'peace', 'user_post', 'PRIMARY KEY');
...
INSERT INTO `USER_PRIVILEGES` VALUES('''airs2010''@''localhost''', NULL, 'USAGE', 'NO');
INSERT INTO `USER_PRIVILEGES` VALUES('''peace''@''localhost''', NULL, 'USAGE', 'NO');
INSERT INTO `USER_PRIVILEGES` VALUES('''RiverCrab''@''localhost''', NULL, 'USAGE', 'NO');
...
INSERT INTO `db` VALUES('localhost', 'airs2010', 'airs2010', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
INSERT INTO `db` VALUES('localhost', 'peace', 'peace', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
INSERT INTO `db` VALUES('localhost', 'RiverCrab', 'RiverCrab', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
...
INSERT INTO `user` VALUES('localhost', 'airs2010', '*4D33FA6447DF53CB5BCD93400D267F4D60C1E9C3', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0);
INSERT INTO `user` VALUES('localhost', 'peace', '*2180D6314B92A5DDFD1F6C2F877E9738A32D651C', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0);
INSERT INTO `user` VALUES('localhost', 'RiverCrab', '*2180D6314B92A5DDFD1F6C2F877E9738A32D651C', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0);
--
-- 資料庫: `peace`
--
CREATE DATABASE `peace` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `peace`;
...
INSERT INTO `post` VALUES(1, 3, 0, 0, '株式會社UNIQLO', '株式會社UNIQLO（日语：ユニクロ，音譯為優衣庫）是經營休閒服裝設計、製造和零售的日本公司，由柳井正創立。原本隸屬迅銷公司旗下，在2005年11月1日公司重整後，UNIQLO現在為迅銷的100%全資附屬公司，1999年2月該公司股票在東京證券交易所第一部上市。[1]在銷售數字和營收方面，UNIQLO是日本連鎖服飾零售業的領導品牌[來源請求]。在中國大陆、香港、南韓、英國、法國、美國和台灣[2][3][4]都設有分店。', '2010-11-03 10:43:33');
INSERT INTO `post` VALUES(3, 3, 0, 0, 'PChome線上購物- 【UNIQLO】', '\r\n	回首頁\r\n看全部商品分類　買不到通知PChome\r\n  	\r\n\r\n| 線上購物 | 24h購物 | 書店 | 軟體 | 　　全球購物：PChome開始出貨到全球105個國家(地區)\r\n故障通報　廠商合作　PChome	\r\n\r\n		\r\n	\r\n	\r\n	\r\n	\r\n\r\n	\r\n	流行女裝	\r\n	品牌服飾	\r\n	女包	\r\n	女鞋	\r\n	男裝	\r\n	男包	\r\n	男鞋	\r\n	時尚錶	\r\n	瑞士錶	\r\n	日本錶	\r\n	珠寶	\r\n	飾品	\r\n	 專櫃保養	\r\n	草本	\r\n	莎莎	\r\n	瑰珀翠	\r\n	藥妝	\r\n	開架	\r\n	美體髮	\r\n	彩妝	\r\n	香水	\r\n	精品	\r\n	內衣	\r\n	男內著	\r\n	華歌爾黛安芬	\r\n	佐丹奴	\r\n	JEEP	\r\n	ADMJ	\r\n	SAC	\r\n	金安德森	\r\n	 HANG TEN	\r\n	PaulFrank	\r\n\r\n\r\n	\r\n 	\r\n【UNIQLO】現貨\r\n 	\r\n\r\nPChome > 線上購物 > 時尚 > 品牌服飾 > 【UNIQLO】現貨	\r\n\r\n 	品牌服飾\r\n 	 	 \r\n 		日本進口品牌\r\n 	 	 　 【UNIQLO】現貨\r\n 	 	 \r\n 		禦寒保暖‧大推薦\r\n 	 	 　 ‧MILD STAR 羽絨衣\r\n　 ‧SOFTSUN\r\n　 ‧TOP GIRL 外套\r\n　 ‧XGAMES 全館7折\r\n 	 	 \r\n 		11月新鮮貨 NEW!\r\n 	 	 　 今日新品\r\n　 本週新品\r\n　 超值任選組\r\n 	 	 \r\n 		出清‧最後折扣\r\n 	 	 　 下殺 ↘ 6折\r\n　 下殺 ↘ 7折\r\n　 下殺 ↘ 8折\r\n　 韓Escape ►6折\r\n　 XGAMES ►7折\r\n　 韓ANNMARIN ►6折\r\n　 美Aero 均一特價►999\r\n　 韓綜合品牌►現貨8折\r\n 	 	 \r\n 		J Daheck\r\n 	 	 　 ►上衣 | T恤\r\n　 ►襯衫 | 背心\r\n　 ►裙裝 | 褲裝\r\n　 ►洋裝 | 連身裙\r\n　 ►外套 | 罩衫\r\n　 【ASIF】\r\n　 【L infini】\r\n　 【Le Forte】\r\n　 【GD時尚】中大尺碼\r\n 	 	 \r\n 		GIORDANO\r\n 	 	 素面上衣 ♀ 4件$1200\r\n 線衫外套 ♀ 2件$1300\r\n 線衫外套 ♀ 2件$1300\r\n 連帽外套 ♀ 2件$1500\r\n 男女條紋上衣 2件$700\r\n 	 	 \r\n 		美國 PAUL FRANK\r\n 	 	 　 ►T恤 \r\n　 ►上衣\r\n　 ►外套\r\n　 ►褲子\r\n　 ►居家服\r\n　 ►APPLE 週邊商品\r\n 	 	 \r\n 		巴西 Coconut\r\n 	 	 　 ►EASY 簡約塗鴉\r\n　 ►Heritage 玩美個性\r\n　 ►Nostagic 復古刷舊\r\n　 ►Special Edition 珍藏\r\n　 ►Statement 詼諧文字\r\n　 【巴西Coconut】85折\r\n 	 	 \r\n 		O.B 美式復古潮T\r\n 	 	 　 ►短T\r\n　 ►七分T\r\n　 ►七分帽T\r\n　 ►美式圓筒彩T\r\n 	 	 \r\n 		美國 T-Shirt.com\r\n 	 	 　 ►新品上市\r\n　 ►美式卡通系列\r\n　 ►幽默翻玩系列\r\n　 ►12星座個性系列\r\n　 ►Marvel 美漫系列\r\n　 ►個性文字圖案系列\r\n　 ►復古電影人物系列\r\n　 ►音樂搖滾樂團系列\r\n 	 	 \r\n 		HANG TEN\r\n 	 	 　 超值任選組\r\n　 ►上衣 | 背心\r\n　 ►經典polo衫\r\n　 ►外套\r\n 	 	 \r\n 		金安徳森\r\n 	 	 　 ►精選棉T | 襯衫\r\n　 ►甜美洋裝 | 背心\r\n　 ►人氣針織 | 線衫\r\n　 ►長短褲裝 | 裙裝\r\n　 ►百搭外套 | 大衣\r\n 	 	 \r\n 		潮流設計\r\n 	 	 　 【HOT HEART】小柔\r\n　 【PsyBushA】手工染\r\n　 【Rock Anthem】 \r\n　 【卡斯柏&麗莎】\r\n 	 	 \r\n 		韓國進口品牌\r\n 	 	 　 【ANNMARIN】6折\r\n　 【BRAND82】\r\n　 【Chic Girl】現貨\r\n　 【eeCute】\r\n　 【Entia】韓瘋美尻\r\n　 【Escape】6折\r\n　 【facoup】8折\r\n　 【Googims】\r\n　 【HEYO】\r\n　 【MUSE 】\r\n　 【Nak-classic】\r\n　 【Narcia】\r\n　 【Q-chic】現貨\r\n　 【Q-chic】預購\r\n　 【Q-chic】泳裝\r\n　 【Roann】蘿安\r\n　 【S-line】\r\n　 【S-line】泳裝\r\n　 【THE SHIRTS】\r\n 	 	 \r\n 		歐美進口品牌\r\n 	 	 　 【A&F】\r\n　 【AE】\r\n　 【Aeropostale】\r\n　 【Banana Republic】\r\n　 【dELiA*s】\r\n　 【Forever21】\r\n　 【GAP】\r\n　 【Hollister Co.】\r\n　 【J.crew】 \r\n　 【OLD NAVY】\r\n　 【Urban Outfitters】\r\n　 綜合品牌\r\n 	 	 \r\n 		牛仔服飾\r\n 	 	 　 【Entia韓瘋美尻】\r\n　 【JEEP】\r\n　 【MISS SIXTY】\r\n 	 	 \r\n 		典雅新貴館\r\n 	 	 　 【Baiter】\r\n　 【MYVEGA 麥雪爾】\r\n　 【SASSY】\r\n　 【城市之光】\r\n 	 	 \r\n 		TOP GIRL\r\n 	 	 　 2010 新品上市\r\n　 ►T恤 | 上衣\r\n　 ►polo衫\r\n　 ►外套\r\n　 ►褲子\r\n　 ►運動套裝\r\n 	 	 \r\n 		運動休閒館\r\n 	 	 　 【adidas】\r\n　 【Anapana】瑜珈\r\n　 【ARTS YOGA】瑜珈\r\n　 【Champion Fish】\r\n　 【FIVE UP】5折\r\n　 【CARAVA】機能服\r\n　 【MILD STAR】瑜珈\r\n　 【Miss Yumi】瑜珈\r\n　 【V TEAM】5折\r\n　 【綜合品牌】休閒 \r\n 	 	 \r\n 		秀行館\r\n 	 	 　 【ETG3】\r\n　 【étoile】35折 up\r\n　 【in-fo】\r\n　 【JIS】滿五千送一千\r\n　 【JLANSO】\r\n　 【MUBI】$999 up\r\n　 【Sabeido】5折 up\r\n　 【V-ZIRE】\r\n 	 	 \r\n 		美麗孕婦裝\r\n 	 	 　 【BABY LOVE】\r\n 	 	 \r\n 		可愛小嬰 / 童裝\r\n 	 	 　 【Googims】韓空運\r\n　 【PAUL FRANK】女童\r\n　 【PAUL FRANK】男童\r\n　 【UNIQLO】日空運\r\n 	 	 \r\n 		過季出清\r\n 	 	 【Miss Yumi】↘299\r\n\r\n 	★ 銷售排行榜\r\n1	\r\n日本 UNIQLO 女裝 迪士尼企劃米奇短袖T恤 C\r\n2	\r\n日本 UNIQLO 女裝 薄透感層次穿搭款馬海毛橫條紋長版針織上衣\r\n3	\r\n日本 UNIQLO 女裝 絨毛內裡長袖刷毛外套\r\n4	\r\n日本 UNIQLO 女裝 編織風七分袖圓領洋裝\r\n\r\n 	★ 新品上架\r\n1	\r\n日本 UNIQLO 女裝 時尚造型反折短褲\r\n2	\r\n日本 UNIQLO 女裝 荷葉邊圓領針織對襟上衣\r\n3	\r\n日本 UNIQLO 女裝 魔境夢遊聯名款１０分長拉鍊內搭褲\r\n4	\r\n日本 UNIQLO 女裝 魔境夢遊聯名款１０分長STONE花紋內搭褲\r\n5	\r\n日本 UNIQLO 女裝 棉x刷毛長袖連帽外套\r\n顯示方式：   標準　   序列\r\n\r\n日本 UNIQLO 女裝 薄款連帽長袖外套\r\n網路價$790  \r\n 	\r\n\r\n日本 UNIQLO 女裝 自然系．皺皺布料蛋糕裙\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n\r\n網路價$ 790 搶購>\r\n\r\n日本 UNIQLO 女裝 內裡起毛橫條紋毛巾布家居休閒外套\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n\r\n網路價$ 1290 搶購>\r\n\r\n日本 UNIQLO 女裝 迪士尼企劃-米奇短袖T恤\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n\r\n網路價$ 590 搶購>\r\n \r\n日本 UNIQLO 女裝 ＶＯＧＵＥ雜誌合作款短袖T恤C\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$590\r\n \r\n日本 UNIQLO 女裝 迪士尼企劃-米奇短袖T恤 D\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$590\r\n \r\n日本 UNIQLO 女裝 柔細刷毛內裡長袖連帽外套\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$790\r\n \r\n日本 UNIQLO 女裝 輕薄款幾何圖案雪紡裙 C\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$790\r\n \r\n日本 UNIQLO 女裝 迪士尼系列-米妮短袖長版T恤 F\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$590\r\n\r\n \r\n日本 UNIQLO 女裝 L.A.設計師品牌velvet合作款短袖上衣\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$790\r\n \r\n日本 UNIQLO 女裝 水洗皺感蛋糕裙\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$790\r\n \r\n日本 UNIQLO 女裝 時尚輕薄披肩風對襟上衣\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$790\r\n \r\n日本 UNIQLO 女裝 編織風七分袖圓領洋裝\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$990\r\n \r\n日本 UNIQLO 女裝 L.A.人氣品牌聯名款竹節紗平口洋裝\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$790\r\n\r\n \r\n日本 UNIQLO 女裝 MONOTONE WORLD GRAPHICS系列薄透款短袖T恤 F\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$590\r\n \r\n日本 UNIQLO 女裝 水洗退色感丹寧短裙\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$790\r\n \r\n日本（gu）女裝 休閒風橫條紋短袖連帽外套\r\n誕生自UNIQLO的品牌\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$590\r\n \r\n日本 UNIQLO 女裝 輕薄款胸口細折圓領七分袖上衣\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$990\r\n \r\n日本（gu）女裝 COOL清涼薄款紅唇印刷短袖上衣\r\n誕生自UNIQLO的品牌\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$490\r\n\r\n \r\n日本 UNIQLO 女裝 dzinestudio合作款短袖上衣 A\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$790\r\n \r\n日本 UNIQLO 女裝 DOMINO唱片聯名款-ROCK風短袖T恤 A\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$590\r\n \r\n日本 UNIQLO 女裝 輕爽COOL風斑馬紋短袖上衣\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$590\r\n \r\n日本 UNIQLO 女裝 迪士尼企劃-人氣款米妮短袖T恤\r\n＊現貨在台＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$590\r\n \r\n日本 UNIQLO 女裝 可愛女孩風．抓皺無袖連衣裙\r\n＊日本平行輸入商品，現貨在台＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$1090\r\n\r\n \r\n日本 UNIQLO 女裝 潮流斑馬紋造型背心\r\n＊日本平行輸入商品，現貨在台＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$790\r\n \r\n日本 UNIQLO 女裝 優雅女人味．背心連身長裙\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$1290\r\n \r\n日本 UNIQLO 女裝 時尚雪紡紗豹紋褶裙\r\n＊現貨在台＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$790\r\n \r\n日本 UNIQLO 女裝 皺皺布料蛋糕裙\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$790\r\n \r\n新品現貨在台↓↓降\r\n日本 UNIQLO 女裝 溫柔女人．多色菱形花紋短袖針織上衣\r\n◆原網路價$1290，活動優惠價↘$799\r\n\r\n＊現貨在台＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$788\r\n\r\n \r\n日本 UNIQLO 女裝 MONOTONE WORLD GRAPHICS系列蝴蝶袖上衣 F\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$590\r\n \r\n日本 UNIQLO 女裝 迪士尼企劃-米奇短袖T恤 F\r\n＊現貨在台＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$590\r\n \r\n日本 UNIQLO 女裝 迪士尼企劃米奇短袖T恤 C\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$590\r\n \r\n日本 UNIQLO 女裝 迪士尼企劃-奇妙仙子長袖連帽上衣\r\n＊現貨在台＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$990\r\n \r\n日本 UNIQLO 女裝 OL時尚長版背心\r\n＊現貨在台，日本平行輸入商品＊\r\n＊款式不同版形大小會有差異，請留意【尺寸表】＊\r\n<<前往UNIQLO 男裝現貨區>>\r\n網路價$1290\r\n\r\n		    1   2   3   4   5   　 下一頁>  		\r\n更多相關商品： UNIQLO　 潮流　 日本　 OL　 060330　\r\n\r\n△回TOP	\r\nPChome線上購物 - 網路家庭國際資訊股份有限公司 版權所有‧轉載必究　\r\n106 台北市大安區敦化南路二段105號12樓　電話(上班時間)：02-2326-1460 (本公司不會以此電話號碼撥打給您，如有來電顯示此號碼，請勿理會)\r\n', '2010-11-03 10:44:34');
INSERT INTO `post` VALUES(4, 3, 0, 0, 'UNIQLO台灣官網', '其實是默默的開張，UNIQLO全球網頁的台灣連結，默默的掛上coming soon的字眼。據悉，即將登陸的官網，會有全球同步的UNIQLO新訊，與詳細的台北UNIQLO ...', '2010-11-03 10:45:10');
INSERT INTO `post` VALUES(5, 4, 0, 0, 'HANG TEN 台灣官方網站', '瞭解HANG TEN的品牌精品與發展歷史。 新訊. 關於HANG TEN的最新活動訊息與新聞稿。 ... 快速查詢距離您最近的HANG TEN門市。 線上購物. HANG TEN 線上購物網', '2010-11-03 15:55:21');
INSERT INTO `post` VALUES(6, 4, 0, 0, 'Hang Ten熟悉的平價服飾品牌', '漢登（Hang Ten），相信大家對它都很熟，它似乎無所不在，幾乎每間百貨公司都有它的蹤影，想要找超便宜的衣服馬上就會想到它，也是許多人從小到大的回憶。', '2010-11-03 15:56:16');
INSERT INTO `post` VALUES(7, 5, 0, 0, 'Roots T-shirt', '首頁 · 產品目錄 · Roots 動態 · 銷售據點 · Roots 分享 · 關於我們 · 網站地圖 · 聯絡我們 · 使用條款 · 加拿大Roots. ROOTS 乃Roots Canada Ltd. 之註冊商標，其特許 ...', '2010-11-03 15:56:45');
INSERT INTO `post` VALUES(8, 5, 0, 0, 'Roots USA – Handcraf', 'Roots has the highest quality handcrafted leather bags, handbags, purses, briefcases that are handcrafted in Canada from premium Italian leather', '2010-11-03 15:57:04');
INSERT INTO `post` VALUES(9, 7, 0, 2, '幸福從來不是在遠方:MAC PRO開箱文', '原本是老友家裡的桌上型電腦掛了，在詢問我有何建議，基於老友一再讚賞iPhone的直覺式的操作介面非常人性化而好用，加上朋友己...', '2010-11-03 17:19:29');
INSERT INTO `post` VALUES(10, 8, 0, 2, 'iPhoneTW台灣iPhone俱樂部-', '2010年10月30日 ... 擁有iPhone不是奢侈，不是炫耀，更非品牌迷失，完美的工業設計、創新的使用介面及開放的穩定系統，將行動通訊與多媒體體驗帶入一個全新的領域，歡迎', '2010-11-03 17:20:06');
INSERT INTO `post` VALUES(11, 7, 0, 2, 'iPhone - Mobile01 討論', 'iPhone!!!!!!!!!!!!!!!!!!!!!', '2010-11-03 17:20:31');
INSERT INTO `post` VALUES(12, 10, 0, 3, '少女時代girls'' generatio', '超青春洋溢的阿!! 最近一直在聽少女時代的歌! 真的得看一看上面這個影片@@ 記得打開HQ, 畫質超清晰的,', '2010-11-03 17:21:42');
INSERT INTO `post` VALUES(13, 10, 0, 3, '正妹星球!! 就是愛正妹: 少女時代', '2009年7月1日 ... 少女時代(girl''s generation) 韓國可愛正妹團體新專輯新造型 少女時代(girl''s generation) 還記得上次介紹過的少女時代(소녀시대)--GEE 嗎？ ...', '2010-11-03 17:22:01');
INSERT INTO `post` VALUES(14, 11, 0, 3, 'YouTube - wait4SJSup', '2010年5月12日 ... 雖然很小心了，字幕還是錯了啊，真不好意思，各位如果介意可以不必轉載。 但是若還是要轉載，請附上以下資訊： 翻譯來源：翻滾吧 ...', '2010-11-03 17:23:40');
...
INSERT INTO `tag` VALUES(0, 'R324_Root', -1);
INSERT INTO `tag` VALUES(2, 'Cloth', 0);
INSERT INTO `tag` VALUES(3, 'UNIQLO', 2);
INSERT INTO `tag` VALUES(4, 'HangTen', 2);
INSERT INTO `tag` VALUES(5, 'Roots', 2);
INSERT INTO `tag` VALUES(6, 'apple', 0);
INSERT INTO `tag` VALUES(7, 'mac', 6);
INSERT INTO `tag` VALUES(8, 'iPhone', 6);
INSERT INTO `tag` VALUES(9, 'KoreanSinger', 0);
INSERT INTO `tag` VALUES(10, 'GirlGeneration', 9);
INSERT INTO `tag` VALUES(11, 'SuperJunior', 9);
...
INSERT INTO `user` VALUES(0, 'dongogo', 'dongogo');
INSERT INTO `user` VALUES(2, 'austintodo', 'ntucsie');
INSERT INTO `user` VALUES(3, 'neant', 'ntucsie');
INSERT INTO `user` VALUES(4, 'kcir', 'ntucsie');
INSERT INTO `user` VALUES(5, 'littleCVR', 'ntucsie');
INSERT INTO `user` VALUES(6, 'shotluck', 'ntucsie');
INSERT INTO `user` VALUES(7, 'JAST', 'ntucsie');
...
INSERT INTO `user_fav` VALUES(1, 0, 0, '3,4');
INSERT INTO `user_fav` VALUES(2, 0, 1, '7,8');
INSERT INTO `user_fav` VALUES(3, 2, 0, '3');
INSERT INTO `user_fav` VALUES(4, 2, 1, '4');
INSERT INTO `user_fav` VALUES(5, 2, 3, '7,8');
...
--
-- 列出以下資料庫的數據： `user_post`
--

INSERT INTO `user_post` VALUES(1, 2, 3, '2010-11-03 18:14:45');
INSERT INTO `user_post` VALUES(2, 2, 5, '2010-11-03 18:14:52');
INSERT INTO `user_post` VALUES(3, 2, 8, '2010-11-03 18:15:16');
INSERT INTO `user_post` VALUES(4, 2, 10, '2010-11-03 18:15:16');
--
-- 資料庫: `test`
--
